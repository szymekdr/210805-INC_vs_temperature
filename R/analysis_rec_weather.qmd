...
data_analysis$TEMP_BROOD <- scale(data_analysis$TEMP_BROOD, center = T, scale = T)
data_analysis$PRCP_BROOD <- scale(data_analysis$PRCP_BROOD, center = T, scale = T)
model2 <- glmer(FLEDGE ~ TEMP_BROOD * PRCP_BROOD + (1|FRING) + (1|YEAR) + (1|AREA) + (1|obs),
                data = data_analysis, family = "poisson")
summary(model2)
plot(model2)
...
data_analysis$TEMP_BROOD <- scale(data_analysis$TEMP_BROOD, center = T, scale = T)
data_analysis$PRCP_BROOD <- scale(data_analysis$PRCP_BROOD, center = T, scale = T)
model3 <- glmer(NEWRECRUIT ~ TEMP_BROOD * PRCP_BROOD + (1|FRING) + (1|YEAR) + (1|AREA) + (1|obs),
                data = data_analysis, family = "poisson")
summary(model3)
plot(model3)
...
data_analysis <- data[,c("TEMP_BROOD", "PRCP_BROOD", "FRING", "YEAR", "FLEDGE", "AREA")]
data_analysis <- na.omit(data_analysis)
nrow(data_analysis)
data_analysis$YEAR <- as.factor(data_analysis$YEAR)
...
data_analysis <- data[,c("TEMP_BROOD", "PRCP_BROOD", "FRING", "YEAR", "NEWRECRUIT", "AREA")]
data_analysis <- na.omit(data_analysis)
nrow(data_analysis)
data_analysis$YEAR <- as.factor(data_analysis$YEAR)
data_analysis$TEMP_BROOD <- scale(data_analysis$TEMP_BROOD, center = T, scale = T)
...
model2.1 <- glmmTMB(FLEDGE ~ TEMP_BROOD * PRCP_BROOD + (1|FRING) + (1|YEAR) + (1|AREA),
...
data_analysis$TEMP_BROOD <- scale(data_analysis$TEMP_BROOD, center = T, scale = T)
data_analysis$PRCP_BROOD <- scale(data_analysis$PRCP_BROOD, center = T, scale = T)
model3.1 <- glmmTMB(NEWRECRUIT ~ TEMP_BROOD * PRCP_BROOD + (1|FRING) + (1|YEAR) + (1|AREA),
                    zi = ~ TEMP_BROOD + PRCP_BROOD,
                    data = data_analysis, family = "nbinom2")
summary(model3.1)
...
model20s <- glm(no_pairs ~ AREA * t_mean_n, data = data_analysis, family = "poisson")
summary(model20s)
```
...
model21s <- glm(no_pairs ~ AREA * p_mean_n, data = data_analysis, family = "poisson")
summary(model21s)
```
...
data_analysis <- data[,c("TEMP_BROOD", "PRCP_BROOD", "FRING", "YEAR", "CS", "NEWRECRUIT", "AREA")]
data_analysis <- na.omit(data_analysis)
