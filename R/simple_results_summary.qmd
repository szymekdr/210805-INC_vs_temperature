...
data_analysis <- data[,c("TEMP_BROOD2", "PRCP_BROOD2", "TEMP_BROOD", "PRCP_BROOD", "FRING", "YEAR", "FLEDGE", "AREA", "obs", "LD")]
...
model1 <- glmmTMB(FLEDGE ~ TEMP_BROOD2 + PRCP_BROOD2 + LD + (1|FRING) + (1|YEAR2) + (1|AREA) + (1|obs),
                    zi = ~ TEMP_BROOD2 * PRCP_BROOD2,
                    data = data_analysis, family = "poisson")
summary(model1)

data_analysis <- data[,c("TEMP_BROOD2", "PRCP_BROOD2", "TEMP_BROOD", "PRCP_BROOD", "FRING", "YEAR", "NEWRECRUIT", "AREA", "obs", "LD")]
data_analysis <- na.omit(data_analysis)
nrow(data_analysis)
data_analysis$YEAR2 <- as.factor(data_analysis$YEAR)
data_analysis$TEMP_BROOD2 <- scale(data_analysis$TEMP_BROOD2, center = T, scale = T)
...
model2 <- glmmTMB(NEWRECRUIT ~ TEMP_BROOD2 * PRCP_BROOD2 + LD + (1|FRING) + (1|YEAR2) + (1|AREA) + (1|obs),
                    zi = ~ TEMP_BROOD2 + PRCP_BROOD2,
                    data = data_analysis, family = "poisson")
summary(model2)
```
